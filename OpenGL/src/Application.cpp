...
int main(void)
{
	...
	unsigned int vao; // create and bind our vertex array object
	GLCall(glGenVertexArrays(1, &vao));
	GLCall(glBindVertexArray(vao));

	unsigned int buffer; // create and bind our buffer
	...
	unsigned int ibo; // create and bind our index buffer object
